...
// 运行: DEC_BW_PASSWORD='...' go test -tags live ./internal/secrets -run TestLive_ProgrammaticUnlock -v
...
// 运行: DEC_BW_PASSWORD='...' go test -tags live ./internal/secrets -run TestLive_PushBundle -v
...
// 运行: DEC_BW_PASSWORD='...' go test -tags live ./internal/secrets -run TestLive_PushThenPull -v
