...
注意：包开发文档和规则现已通过 CursorColdStart 的 cursortoolset pack 提供，
请使用 coldstart enable cursortoolset 获取完整的开发指南。
...
示例：
  cursortoolset sync`,
	RunE: func(cmd *cobra.Command, args []string) error {
		...
		fmt.Println("   请运行: coldstart enable cursortoolset && coldstart init .")
