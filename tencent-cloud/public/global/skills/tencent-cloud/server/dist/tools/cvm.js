...
export function registerCvmTools(server, ctx) {
    server.registerTool("cvm_describe_instances", {
    ...
    server.registerTool("cvm_describe_security_groups", {
    ...
    server.registerTool("cvm_run_command", {
    ...
    server.registerTool("cvm_upload_file", {
    ...
    server.registerTool("cvm_download_file", {
    ...
    server.registerTool("cvm_describe_invocation", {
